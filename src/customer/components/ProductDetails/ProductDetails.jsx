            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className='flex items-center space-x-3'>
                  ...
                  <p className='ml-3 text-sm font-medium text-indigo-600'>300 Reviews</p>
                </div>
            ...
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-68">54890 Ratings</p>
                </div>
                <Box className="mt-5 space-y-2">
                  ...
                  <Grid item xs={7}>
                      <LinearProgress sx={{ borderRadius:4, height:7, bgcolor: "#d0d0d0" }}
                  ...
                  <Grid item xs={7}>
                      <LinearProgress sx={{ borderRadius:4, height:7, bgcolor: "#d0d0d0", color: "yellow" }}
                  ...
                  <Grid item xs={7}>
                      <LinearProgress sx={{ borderRadius:4, height:7, bgcolor: "#d0d0d0" }}
                      variant="determinate" value={30} color='warning'/>
                  </Grid>
